...
class BalanceOperationTest {
    ...
    void testInvalidBalanceForMonth() {
        ...
        Exception ex = Assertions.assertThrows(InvalidInput.class, () -> BalanceOperation.getInstance().processRequest(transactions, input), "Sample");
    ...
    void processRequest() throws Exception {
        TreeMap<Integer, LinkedList<Allocate>> transactions = new TreeMap<>();
        ...
        BalanceOperation.getInstance().processRequest(transactions, input);
